...
CREATE TABLE IF NOT EXISTS ${forecastDbName}.supply_sample_next_local
(
...
ENGINE = ReplicatedMergeTree('/clickhouse/{cluster}/tables/{shard}/${forecastDbName}/supply_sample_next_local', '{replica}')
...
CREATE TABLE IF NOT EXISTS ${forecastDbName}.supply_sample_next
AS ${forecastDbName}.supply_sample_next_local
ENGINE = Distributed('{cluster}', '${forecastDbName}', 'supply_sample_next_local', rand());
